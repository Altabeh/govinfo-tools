...
class SS3(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.resource = boto3.resource('s3', aws_access_key_id=self.public_key,
                                       aws_secret_access_key=self.secret_key,)
    ...
    def fetch(self, directory, key, version_id=None, chunk_size=10000000):
        ...
        with open(file_path, 'wb') as f:
            ...
            file_size = self.resource.Bucket(
                self.bucket_name).Object(key).content_length
    ...
    def create_presigned_url(self, key):
        ...
        try:
            response = self.client.generate_presigned_url('get_object',
                                                          Params={'Bucket': self.bucket_name, 'Key': key}, ExpiresIn=self.presigned_expiration)
