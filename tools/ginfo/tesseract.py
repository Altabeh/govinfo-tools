...
class Tesseract(object):
    ...
    def __init__(self, language='eng_fast', datapath=None, lib_path=None):
        ...
        if self._lib.TessBaseAPIInit3(self._api, datapath, bytes(language, encoding='utf-8')):
    ...
    def set_variable(self, key, val):
        ...
        """
        self._check_setup()
        self._lib.TessBaseAPISetVariable(self._api, bytes(
            key, encoding='utf-8'), bytes(val, encoding='utf-8'))
